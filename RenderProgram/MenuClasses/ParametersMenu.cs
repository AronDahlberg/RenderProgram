...
namespace RenderProgram.MenuClasses
{
    internal static class ParametersMenu
    {
        public static void PrintMenu()
        {
            ...
            if (Program.Settings.GeneralParameters?.Parameters != null)
            {
        ...
        public static void ExecuteMenuAction(string input)
        {
            switch (input)
            {
                ...
                default:
                    ...
                    if (parameterIndex < generalParametersLenght && Program.Settings.GeneralParameters?.Parameters != null)
                    {
                    ...
                    {
                        PropertyInfo[]? properties = Program.CurrentShape?.GetType().GetProperties(BindingFlags.Public | BindingFlags.Instance);
                        properties?[parameterIndex - generalParametersLenght ?? parameterIndex].SetValue(Program.CurrentShape, value);
                    }
                    break;
            }
        }
